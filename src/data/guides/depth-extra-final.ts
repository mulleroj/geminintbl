...
export const depthExtraFinal: GuideDepthExtension[] = [
  ...
  },
  {
    id: 'g-video-overview',
    sections: [
      { heading: 'Storyboard před generováním', paragraphs: ["Vytvořte storyboard s časem, obrazem, hlasem, tvrzením a zdrojem pro každou scénu. U scény, která nemá jednoznačnou vizuální oporu, použijte text nebo neutrální schéma. Filmový obraz nesmí doplnit událost, osobu nebo příčinu jen proto, že se hodí do příběhu.", "Po renderu porovnejte storyboard se skutečným výsledkem. Pokud nástroj změnil pořadí nebo vynechal scénu, upravte video brief a označte verzi. Nepřepisujte výstup jako „podle zdrojů“ bez kontroly všech vrstev.", "Po ověření můžete storyboard převést do výuky. Ke každé scéně doplňte otázku pro žáky a místo, kam se mají vrátit ve zdroji. Video pouštějte po úsecích: před scénou nechte žáky předpovědět další krok, po scéně označit tvrzení a na konci vlastními slovy vysvětlit hlavní myšlenku. Ze storyboardu tak vznikne pracovní list, exit ticket nebo zadání pro vlastní mini-video. Když video nepoužijete, storyboard zůstává použitelný jako textový scénář, slide deck nebo schéma."], bullets: ['čas scén', 'vizuální opora', 'hlas a titulky', 'otázka pro žáky', 'návrat ke zdroji', 'výstup žáka', 'verze po renderu'] },
