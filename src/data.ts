...
export { promptCategories, sourceCategories, guideCategories } from './data/categories';
...
import { guideCategories, promptCategories, sourceCategories } from './data/categories';
...
export const catalogIntegrity = assertCatalogValid({ prompts, sources, tools, notebooks, guides, promptCategories, sourceCategories, guideCategories });
